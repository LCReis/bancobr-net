...
namespace BancoBr.Common.Core
{
    public static class CodigoOcorrenciasRetorno
    {
        public static List<Ocorrencia> Ocorrencias => new List<Ocorrencia>
        {
            ...
            new Ocorrencia("BI", "CPF ou CNPJ do Favorecido inválido"),
            ...
            new Ocorrencia("CQ", "Soma das faturas difere do pagamento"),
            new Ocorrencia("CR", "Valor do CSLL inválido"),
            new Ocorrencia("CS", "Data de vencimento da fatura inválida"),
            new Ocorrencia("DA", "Número de depend. salário família inválido"),
            new Ocorrencia("DB", "Número de horas semanais inválido"),
            new Ocorrencia("DC", "Salário de contribuição INSS inválido"),
            new Ocorrencia("DD", "Salário de contribuição FGTS inválido"),
            new Ocorrencia("DE", "Valor total dos proventos inválido"),
            new Ocorrencia("DF", "Valor total dos descontos inválido"),
            new Ocorrencia("DG", "Valor líquido não numérico"),
            new Ocorrencia("DH", "Valor liq. informado difere do calculado"),
            new Ocorrencia("DI", "Valor do salário-base inválido"),
            new Ocorrencia("DJ", "Base de cálculo IRRF inválida"),
            new Ocorrencia("DK", "Base de cálculo FGTS inválida"),
            new Ocorrencia("DL", "Forma de pagamento incompatível com holerite"),
            new Ocorrencia("DM", "E-mail do favorecido inválido"),
            new Ocorrencia("DV", "DOC / TED devolvido pelo banco favorecido"),
            new Ocorrencia("D0", "Finalidade do holerite inválida"),
            new Ocorrencia("D1", "Mês de competencia do holerite inválida"),
            new Ocorrencia("D2", "Dia da competencia do holerite inválida"),
            new Ocorrencia("D3", "Centro de custo inválido"),
            new Ocorrencia("D4", "Campo numérico da funcional inválido"),
            new Ocorrencia("D5", "Data início de férias não numérica"),
            new Ocorrencia("D6", "Data início de férias inconsistente"),
            new Ocorrencia("D7", "Data fim de férias não numérico"),
            new Ocorrencia("D8", "Data fim de férias inconsistente"),
            new Ocorrencia("D9", "Número de dependentes IR inválido"),
            new Ocorrencia("EM", "Confirmação de OP emitida"),
            new Ocorrencia("EX", "Devolução de OP não sacada pelo favorecido"),
            new Ocorrencia("E0", "Tipo de movimento holerite inválido"),
            new Ocorrencia("E1", "Valor 01 do holerite / Informe inválido"),
            new Ocorrencia("E2", "Valor 02 do holerite / Informe inválido"),
            new Ocorrencia("E3", "Valor 03 do holerite / Informe inválido"),
            new Ocorrencia("E4", "Valor 04 do holerite / Informe inválido"),
            new Ocorrencia("FC", "Pagamento efetuado através de financiamento compror"),
            new Ocorrencia("FD", "Pagamento efetuado através de financiamento descompror"),            
            ...
            new Ocorrencia("IS", "Concessionária não conveniada com itáu"),
            new Ocorrencia("IT", "Valor do tributo inválido"),
            new Ocorrencia("IU", "Valor da receita bruta acumulada inválido"),
            new Ocorrencia("IV", "Número do documento origem / referência inválido"),
            new Ocorrencia("IX", "Código do produto inválido"),
            new Ocorrencia("LA", "Data de pagamento de um lote alterada"),
            new Ocorrencia("LC", "Lote de pagamentos cancelado"),
            new Ocorrencia("NA", "Pagamento cancelado por falta de autorização"),
            new Ocorrencia("NB", "Identificação do tributo inválida"),
            new Ocorrencia("NC", "Exercício (ano base) inválido"),
            new Ocorrencia("ND", "Código renavam não encontrado / inválido"),
            new Ocorrencia("NE", "UF inválida"),
            new Ocorrencia("NF", "Código do município inválido"),
            new Ocorrencia("NG", "Placa inválida"),
            new Ocorrencia("NH", "Opção / parcela de pagamento inválida"),
            new Ocorrencia("NI", "Tributo já foi pago ou está vencido"),
            ...
            new Ocorrencia("RJ", "Registro Rejeitado"),
            new Ocorrencia("RS", "Pagamento disponível para antecipação no risco sacado - Modalidade risco sacado pós autorizado"),
            ...
            new Ocorrencia("X4", "Forma 32 inválida"),
